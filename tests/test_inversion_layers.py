...
import numpy as np
from eurec4a_environment.variables import inversion_layers
...
def test_inversion_static_stability():
    ...
    da_ss = inversion_layers.inversion_layer_height.calc_inversion_static_stability(ds)
    assert len(da_ss) == 10
...
def test_inversion_gradient_RH_T():
    ...
    da_gradRH_T = inversion_layers.inversion_layer_height.calc_inversion_grad_RH_T(ds)

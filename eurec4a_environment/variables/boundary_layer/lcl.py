...
def find_LCL_Bolton(
    ...
    da_temperature = get_field(ds=ds, field_name=temperature, units="K")
    da_rh = get_field(ds=ds, field_name=rh, units="1")
    da_altitude = get_field(ds=ds, field_name=altitude, units="m")
